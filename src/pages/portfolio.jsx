...
const PortfolioPage = (props) => {
	...
	return (
		<Layout>
			<div className='info'>
				<h2 className='info-title'>{portfolioData?.main_heading}</h2>
				<h3 className='info-subtitle'>{portfolioData?.sub_heading}</h3>
				<div
					className='info-body'
					dangerouslySetInnerHTML={{
						__html: portfolioData?.body.data.childMarkdownRemark
							.html,
					}}
				/>
				{/* <div className='external-links flex'>
					<a
						...
						rel='noreferrer'
					>
						<Icon path={mdiGithub} size={2.5} className='icon' />
					</a>
					<a
						...
						rel='noreferrer'
					>
						<Icon path={mdiLinkedin} size={2.5} className='icon' />
					</a>
